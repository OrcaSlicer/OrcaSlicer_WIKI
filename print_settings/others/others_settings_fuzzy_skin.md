...
Variable: `fuzzy_skin_noise_type`.  
...
Variable: `fuzzy_skin_point_distance`.  
...
Variable: `fuzzy_skin_persistence`.  
...
Variable: `fuzzy_skin_first_layer`.  
