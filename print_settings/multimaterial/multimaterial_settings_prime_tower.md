...
Variable: `wipe_tower_max_purge_speed`.  
...
Variable: `wipe_tower_cone_angle`.  
...
Variable: `wipe_tower_extra_rib_length`.  
...
Variable: `wipe_tower_rib_width`.  
Width of the rib wall.

#### Fillet wall

Variable: `wipe_tower_fillet_wall`.  
The wall of prime tower will fillet.

## No sparse layers

Variable: `wipe_tower_no_sparse_layers`.  
