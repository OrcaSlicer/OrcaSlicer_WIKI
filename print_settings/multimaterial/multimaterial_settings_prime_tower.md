...
Variables: `wipe_tower_max_purge_speed`.
...
Variables: `wipe_tower_wall_type`.
...
Variables: `wipe_tower_cone_angle`.
...
Variables: `wipe_tower_extra_rib_length`.
...
Variables: `wipe_tower_rib_width`.
Width of the rib wall.

#### Fillet wall

Variables: `wipe_tower_fillet_wall`.
The wall of prime tower will fillet.

## No sparse layers

Variables: `wipe_tower_no_sparse_layers`.
