...
Variable: `small_perimeter_speed`.  
...
Variable: `small_perimeter_threshold`.  
...
Variable: `internal_solid_infill_speed`.  
...
Variable: `support_interface_speed`.  
