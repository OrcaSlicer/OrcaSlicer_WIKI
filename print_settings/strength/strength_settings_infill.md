...
Variables: `sparse_infill_density`.
...
Variables: `symmetric_infill_y_axis`.
...
Variables: `internal_solid_infill_pattern`.
...
Variables: `sparse_infill_pattern`.
> [!TIP]
