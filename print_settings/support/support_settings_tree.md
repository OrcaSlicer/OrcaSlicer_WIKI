...
Variables: `tree_support_tip_diameter`.  
Branch tip diameter for organic supports.

## Branch Distance

Variables: `tree_support_branch_distance`, `tree_support_branch_distance_organic`.  
This setting determines the distance between neighboring tree support nodes.

## Branch Density

Variables: `tree_support_top_rate`.  
...
Variables: `tree_support_branch_diameter`, `tree_support_branch_diameter_organic`.  
This setting determines the initial diameter of support nodes.

## Branch Diameter Angle

Variables: `tree_support_branch_diameter_angle`.  
...
Variables: `tree_support_branch_angle`, `tree_support_branch_angle_organic`.  
...
Variables: `tree_support_angle_slow`.  
