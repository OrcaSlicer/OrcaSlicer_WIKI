...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| **Infill** | Füllung | Relleno | Remplissage | Riempimento | Preenchimento | Vulling | Farciment | Výplň | Wypełnienie | Kitöltés | Užpildas | Ifyllnad | Dolgu | Заполнение | Заповнення | インフィル | 채우기 | 填充 | 填充 | ไส้ใน | — |
| **Sparse infill** | Füllung | Relleno poco denso | Remplissage | Riempimento sparso | Preenchimento esparso | Dunne vulling (infill) | Farciment poc dens | Řídká výplň | Wypełnienie | Kitöltés | Retas užpildas | Sparsam ifyllnad | Dolgu | Заполнение | Часткове заповнення | スパース インフィル | 드문 채우기 | 稀疏填充 | 稀疏填充 | ไส้ในแบบโปร่ง | Infill thưa |
| **Outer wall** | Außenwand | Perímetro externo | Paroi extérieure | Parete esterna | Parede externa | Buitenste wand | Perímetre exterior | Vnější stěna | Zewnętrzna ściana | Külső fal | Išorinė sienelė | Yttre vägg | Dış duvar | Внешние периметры | Зовнішня стінка | 外壁 | 외벽 | 外墙 | 外牆 | ผนังด้านนอก | Thành ngoài |
| **Inner wall** | Innere Wand | Perímetro interno | Paroi intérieure | Parete interna | Parede interna | Binnenste wand | Perímetre interior | Vnitřní stěna | Wewnętrzna ściana | Belső fal | Vidinė sienelė | Inre vägg | İç duvar | Внутренние периметры | Внутрішня стінка | 内壁 | 내벽 | 内墙 | 內牆 | ผนังด้านใน | Thành trong |
...
| **Wipe tower** *(= Prime tower)* | Reinigungsturm | Torre de purga | Tour d’essuyage | Torre di spurgo | Torre de limpeza | Afveegblok | Torre de Purga | Věž na očištění trysky | Wieża czyszcząca | Törlőtorony | Valymo bokštas | — | Silme kulesi | Черновая башня | Вежа протирання | ワイプタワー | 프라임 타워 | 擦拭塔 | 換料塔 | ทาวเวอร์เช็ดหัวฉีด | — |
| **PA Tower** *(Pressure Advance calibration)* | PA Turm | Torre PA | Tour PA | Torre AP | Torre de PA | PA-toren | Torre PA( Pressure Advance ) | PA věž | Wieża PA | PA-torony | PA bokštelis | PA torn | PA Kulesi | Башня | РА Вежа | PAタワー | PA 타워 | PA塔 | PA 塔 | พีเอ ทาวเวอร์ | Tháp PA |
...
| **Fuzzy skin** | Fuzzy skin | Piel rugosa | Surface irrégulière | Superficie ruvida | Textura difusa | Vage buitenkant | Pell difusa | — | Skóra fuzzy | Barázdált felület | Grublėtas paviršius | Ojämn Yta | Pütürlü Yüzey | Нечёткая оболочка | Шорстка Поверхня | ファジー壁面 | 퍼지 스킨 | 绒毛表面 | 絨毛表面 | ผิวฟัซซี | — |
| **Fuzzy skin – Perlin** | Perlin | Perlin | Perlin | Perlin | Perlin | Perlin | Perlin | Perlin | Perlin | Perlin | Perlino (Perlin) | Perlin | Perlin | Шум Перлина | Перлін | Perlin | 펄린 | 柏林噪波 | 柏林 | เพอร์ลิน | Perlin |
| **Fuzzy skin – Billow** | Billow | Ondulado | Billow | Ondulato | Billow | Billow | Billow | Vlnění | Billow | Billow | Gubruotas (Billow) | Billow | Billow | Волнообразный | Хвильовий | Billow | 빌로우 | 云状噪波 | 波狀 | บิลโลว์ | Billow |
| **Fuzzy skin – Ridged Multifractal** | Ridged Multifractal | Multifractal Rugoso | Multifractal strié | Multifrattale ruvido | Multifractal estriado | — | Multifractal estriat | Rýhovaný multifraktál | Pofałdowany multifraktal | Bordás multifraktális | Keterinis multifraktalas (Ridged Multifractal) | — | — | Гребенчатый | Гребеневий мультифрактал | — | 리지드 멀티프랙탈 | 脊状多重分形 | 脊狀多重分形 | Multifractal แบบสัน | — |
| **Fuzzy skin – Voronoi** | Voronoi | Voronoi | Voronoi | Voronoi | Voronoi | Voronoi | Voronoi | Voronoi | Voronoi | Voronoi | Voronojaus (Voronoi) | Voronoi | Voronoi | Шум Вороного | Вороного | Voronoi | 보로노이 | 维诺图 | 沃羅諾伊 | โวโรน้อย | Voronoi |
...
| **Extruder** | Extruder | Extrusor | Extrudeur | Estrusore | Extrusora | — | Extrusor | — | Ekstruder | — | Ekstruderis (Stūmiklis) | — | Ekstruder | Экструдер | Екструдер | 押出機 | 압출기 | 挤出机 | 擠出機 | ชุดดันเส้น | — |
...
| **Bowden** | Bowden | Bowden | Bowden | Bowden | Tubo | Bowden | Bowden | Bowden | Bowden | Bowden | Bowdeno vamzdelis (Bowden) | Bowden | Bowden | Внешний (Bowden) | Боуден | ボーデン | 보우덴 | 远程挤出机 | 遠程擠出機 | โบว์เดน | Bowden |
...
| **Cool Plate** | Kalte Druckplatte | Cama Fría | Cool Plate/Plaque PLA | Piatto a bassa temperatura | Placa Fria | Cool (koud) printbed | Base Freda | Chladicí deska | Cool Plate / PLA Plate | — | Šaltas pagrindas | Kall platta | Soğuk plaka | Гладкое (низкотемп.) | Холодна пластина | 常温プレート | 쿨 플레이트 | 低温打印热床 | 低溫列印板 | จานเย็น | Bản Cool |
| **Engineering Plate** | Technische Druckplatte | Cama de Ingeniería | Plaque Engineering | Piatto ingegneristico | Placa de Engenharia | Engineering plate (technisch printbed) | Base d'Enginyeria | Inženýrská deska | — | Műszaki tálca | Inžinerinis pagrindas | — | — | Инженерный лист Bambu | Інженерна Пластина | エンジニアリングプレート | 엔지니어링 플레이트 | 工程材料热床 | 工程列印板 | แผ่นวิศวกรรม | Bản Engineering |
...
| **Retraction** | Rückzug | Retracción | Rétraction | Retrazione | Retração | Terugtrekken (retraction) | Retracció | Retrakce | Retrakcja | Visszahúzás | Atitraukimas (Retraction) | Reduktion | Geri Çekme | Откат | Втягування | リトラクション | 후퇴 | 回抽 | 回抽 | การดึงกลับ | Rút |
