...
* **`{first_object_name}` filename placeholder** by @raistlin7447 in [14497](https://github.com/OrcaSlicer/OrcaSlicer/pull/14497)
    ...
    <img width="700" alt="first_object_name filename placeholder" src="https://github.com/user-attachments/assets/edcca01f-25cb-4160-b1ba-74a096eaca49" />

* **Wiki links and a tidier Preferences dialog** by @yw4z in [13857](https://github.com/OrcaSlicer/OrcaSlicer/pull/13857)
    ...
    <img width="550" alt="Wiki link support in the Preferences dialog" src="https://github.com/user-attachments/assets/0c9a94bb-a5e5-4f26-9725-d31fdd5c9e30" />

* **Use number-or-percentage settings in custom G-code** by @Noisyfox in [14526](https://github.com/OrcaSlicer/OrcaSlicer/pull/14526)
...
* **Name the preset in cloud-sync messages** by @SoftFever in [14592](https://github.com/OrcaSlicer/OrcaSlicer/pull/14592)
...
* **Repair presets that pointed at renamed or deleted profiles** by @SoftFever in [14595](https://github.com/OrcaSlicer/OrcaSlicer/pull/14595)
...
* **Reconnect older presets to renamed profiles** by @peachismomo and @SoftFever in [14507](https://github.com/OrcaSlicer/OrcaSlicer/pull/14507)
...
* **Keep filaments compatible with renamed printers** by @peachismomo and @SoftFever in [14504](https://github.com/OrcaSlicer/OrcaSlicer/pull/14504)
...
* **Correct the type label in the preset bundle dialog** by @peachismomo in [14481](https://github.com/OrcaSlicer/OrcaSlicer/pull/14481)
    In the preset bundle dialog, process presets were labeled with the type "preset"; they now correctly show "process".

## Cloud sync & accounts

* **Keep disabled filament overrides off after cloud sync** by @ExPikaPaka in [14550](https://github.com/OrcaSlicer/OrcaSlicer/pull/14550)
...
* **Fix version not updating correctly on Linux and macOS** by @SoftFever in [14617](https://github.com/OrcaSlicer/OrcaSlicer/pull/14617)
...
* **Stop two open copies from logging each other out** by @peachismomo in [14531](https://github.com/OrcaSlicer/OrcaSlicer/pull/14531)
...
* **Stop the repeated "reinstall Bambu network plugin" prompt** by @Noisyfox in [14511](https://github.com/OrcaSlicer/OrcaSlicer/pull/14511)
...
* **Fix "plug-in file may be in use" when switching plugin versions on Windows** by @ExPikaPaka in [14528](https://github.com/OrcaSlicer/OrcaSlicer/pull/14528)
...
* **Fix slicing failure when filament end G-code uses `{layer_z}` with a prime tower** by @raistlin7447 in [14462](https://github.com/OrcaSlicer/OrcaSlicer/pull/14462)
...
* **Fix an inaccurate print-time estimate** by @SoftFever in [14573](https://github.com/OrcaSlicer/OrcaSlicer/pull/14573)
...
* **Fix crash when rotating the prime tower** by @raistlin7447 in [14499](https://github.com/OrcaSlicer/OrcaSlicer/pull/14499)
...
* **Fix crash in the Measure tool** by @raistlin7447 in [14538](https://github.com/OrcaSlicer/OrcaSlicer/pull/14538)
...
* **Fix crash in Pressure Advance pattern calibration** by @raistlin7447 in [14447](https://github.com/OrcaSlicer/OrcaSlicer/pull/14447)
...
* **Fix Reload from Disk for STEP models after reopening a project** by @SoftFever in [14591](https://github.com/OrcaSlicer/OrcaSlicer/pull/14591)
    ...
    <img width="600" alt="Export full source paths option in Preferences" src="https://github.com/user-attachments/assets/506dfe74-c119-4f98-bfd5-fb6bd9d3e5a4" />

# 🖨️ Printer & Filament Profiles

* **add:north filaments** — adds ready-made profiles for add:north filaments to the Orca Filament Library by @valerii-bokhan in [13366](https://github.com/OrcaSlicer/OrcaSlicer/pull/13366)

    <img width="600" alt="add:north filaments in the Filament Library" src="https://github.com/user-attachments/assets/3d966dd3-e10b-4488-88d7-4b3f124103b5" />
