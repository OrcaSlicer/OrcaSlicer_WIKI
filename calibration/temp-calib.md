...
> But if you are planning to print at higher [speeds](speed_settings_other_layers_speed)/[flow Ratios](volumetric-speed-calib), you may want to use the higher end of that range as the optimal temperature.
