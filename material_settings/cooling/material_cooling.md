...
Variables: `close_fan_the_first_x_layers`.
...
Variables: `full_fan_speed_layer`.
...
Variables: `fan_min_speed`, `fan_cooling_layer_time`, `fan_max_speed`, `slow_down_layer_time`.
...
Variables: `reduce_fan_stop_start_freq`.
...
Variables: `slow_down_for_layer_cooling`.
...
Variables: `dont_slow_down_outer_wall`.
...
Variables: `enable_overhang_bridge_fan`.
...
Variables: `overhang_fan_threshold`.
...
Variables: `internal_bridge_fan_speed`.
...
Variables: `support_material_interface_fan_speed`.
...
Variables: `additional_cooling_fan_speed`.
...
Variables: `activate_air_filtration`.
